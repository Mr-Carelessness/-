...
public class FrmCommoditymg_modify extends JFrame implements ActionListener {
	private JTextField textField_name;
	private JTextField textField_catId;
	private JTextField textField_brand;
	private FrmCommoditymg super_Jrame = null; 
	JButton button_modify = new JButton("\u4FEE\u6539\u5546\u54C1");
	...
	public FrmCommoditymg_modify(FrmCommoditymg frmCommoditymg,int i) {
		this.super_Jrame = frmCommoditymg;
		this.selectedRow = i;
		this.commodity = frmCommoditymg.commoditys.get(this.selectedRow);//获取对应一行的brand
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == this.button_modify) {
			...
			try {
				...
				List<Commodity> list = cm.searchCommodity(c.getId(),choice_commodity);
				...
				c = this.commodity;
				JOptionPane.showMessageDialog(null, "修改商品成功", "正确提示",JOptionPane.INFORMATION_MESSAGE);
				//所有的都要修改一遍
