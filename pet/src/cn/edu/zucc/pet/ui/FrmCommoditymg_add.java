...
public class FrmCommoditymg_add extends JFrame implements ActionListener {
	...
	public FrmCommoditymg_add(FrmCommoditymg frmCommoditymg) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == this.button_add) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "新增商品成功，该商品编号为"+commodity.getId(), "正确提示",JOptionPane.INFORMATION_MESSAGE);
