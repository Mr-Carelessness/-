...
public class FrmCommoditysch extends JFrame implements ActionListener {
	...
	public FrmCommoditysch() {
		...
		JLabel label_1 = new JLabel("\u5546\u54C1\u4FE1\u606F\u67E5\u8BE2\uFF1A");
		label_1.setFont(new Font("宋体", Font.BOLD, 15));
		toolBar.add(label_1);
		
		Component horizontalStrut_2 = Box.createHorizontalStrut(250);
		toolBar.add(horizontalStrut_2);
		
		JLabel label = new JLabel("(\u5546\u54C1/\u670D\u52A1/\u7C7B\u522B)\u7F16\u53F7\u6216\u540D\u79F0\uFF1A");
	...
	public void reloadTable(boolean isUpdated){
		try {
			if(isUpdated == false) {
				commoditys = (new CommodityManager()).searchCommodityFromKeyWord(this.textField.getText());
			}
